...
/* onst cars = ["Audi", "Opel", "Fiat"]
const cars2 = ["BMW", "Ferrari"]

const cars3 = cars.concat(cars2, "Mercedes",2021)
console.log(cars);
console.log(cars2);
console.log(cars3);// ["Audi", "Opel", "Fiat", "BMW", "Ferrari", "Mercedes", 2021]

console.log(cars+cars2); // strin ifadeye döner array lar. Audi,Opel,FiatBMW,Ferrari */
